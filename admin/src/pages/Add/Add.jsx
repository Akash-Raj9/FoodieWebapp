...
const Add = ({ url }) => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    if (data.id) formData.append("id", data.id);  // <-- Append id only if user provided it
    ...
    <div className='add'>
      <form className='flex-col' onSubmit={onSubmitHandler}>
        ...
        <div className='add-product-id flex-col'>
          <p>Product ID (Leave blank for auto-generated)</p>
          <input onChange={onChangeHandler} value={data.id} type="text" name='id' placeholder='Enter Product ID (optional)' />
        </div>
